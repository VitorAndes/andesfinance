...
export function UserDataTab() {
  ...
  return (
    <>
      <p className="font-title font-semibold text-sm md:text-lg mb-5">
      ...
      <div className="starting:-translate-y-10 flex translate-y-0 items-center justify-center rounded-md border border-secondary/80 p-4 transition-all duration-500 flex-wrap gap-5 md:justify-between">
        ...
        <div>
          <Button
            variant="danger"
            onClick={() => deleteData(Selectedata.income)}
          >
            Deletar dados
          </Button>
        </div>
      ...
      <div className="starting:-translate-y-10 flex translate-y-0 items-center justify-center rounded-md border border-secondary/80 p-4 transition-all duration-500 flex-wrap gap-5 md:justify-between">
        ...
        <div>
          <Button
            variant="danger"
            onClick={() => deleteData(Selectedata.expense)}
          >
            Deletar dados
          </Button>
        </div>
      ...
      <div className="starting:-translate-y-10 flex translate-y-0 items-center justify-center rounded-md border border-secondary/80 p-4 transition-all duration-500 flex-wrap gap-5 md:justify-between">
        ...
        <div>
          <Button
            variant="danger"
            onClick={() => deleteData(Selectedata.invoice)}
          >
            Deletar dados
          </Button>
        </div>
