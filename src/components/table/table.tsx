        ...
        <div className="flex w-full flex-col gap-2">
          <div className="flex flex-col gap-2">
            {paginatedItems.length === 0 ? (
              <picture className="flex flex-col items-center m-auto">
                <img
                  src="/transaction.svg"
                  alt="imagem de pessoas fazendo uma transação"
                  loading="lazy"
                  height={100}
                  width={300}
                />
                <p className="font-secondary">Nenhuma transação encontrada</p>{" "}
              </picture>
            ) : (
